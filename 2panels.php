	<div id="linksBar" style="width: 489px;">
		<a id="reloadLink" href="./?numpanels=<?=$_GET['numpanels'] ?>"><span id="reloadButton" class="unpressedReloadButton"><img src="images/reload.png" alt="" />&nbsp;<span id="reloadText">Reload the panels</span></span></a>
