...
<div>
	<span id="tlLock" class="<?=$lockClasses["tl"] ?>Lock twoPanelLock threePanelLock lockSpan startingLock" style="width: 244px;"><img src="lock_open.png" alt="Click to lock" /></span>
	<span id="brLock" class="<?=$lockClasses["br"] ?>Lock lockSpan twoPanelLock threePanelLock startingLock" style="width: 243px;"><img src="lock_open.png" alt="Click to lock" /></span>
	<span id="tmLock" class="<?=$lockClasses["tm"] ?>Lock threePanelLock lockSpan hidden notShowing" style="width: 129px;"><img src="lock_open.png" alt="Click to lock" /></span>
