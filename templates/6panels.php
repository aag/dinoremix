    <div id="linksBar" style="width: 735px;">
        <a id="reloadLink" href="/?numpanels=6"><span id="reloadButton" class="unpressedReloadButton"><img src="images/reload.png" alt="" />&nbsp;<span id="reloadText">Reload the panels</span></span></a>
