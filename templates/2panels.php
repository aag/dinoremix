<div class="ButtonsRow">
    ...
    <div class="NumPanelsWrapper">
        Number of panels: <span class="NumPanelsSwitcher">
            <a href="<?= htmlspecialchars($permaLink2Panels) ?>" class="NumPanelsButton NumPanelsButton--chosen">2</a>
            <a href="<?= htmlspecialchars($permaLink3Panels) ?>" class="NumPanelsButton NumPanelsButton--unchosen">3</a>
            <a href="<?= htmlspecialchars($permaLink6Panels) ?>" class="NumPanelsButton NumPanelsButton--unchosen">6</a>
        </span>
    </div>
</div>
