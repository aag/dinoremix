<div id="linksBar" style="width: 489px;" class="clearfix">
    ...
    <div id="numPanelsHolder">
        Number of panels: <span id="panelNumSwitcher"><a id="twoPanelsLink" href="<?= $permaLink2Panels ?>" class="panelNumLink chosenPanelNumLink">2</a> <a id="threePanelsLink" href="<?= $permaLink3Panels ?>" class="panelNumLink unchosenPanelNumLink">3</a> <a id="sixPanelsLink" href="<?= $permaLink6Panels ?>" class="panelNumLink unchosenPanelNumLink">6</a></span>
    </div>
</div>

<div class="topLocks clearfix">
    ...
    <span id="tmLock" class="<?=$lockClasses["tm"] ?>Lock threePanelLock lockSpan hidden notShowing" style="width: 129px;"><img src="images/lock_open.png" alt="Click to lock" /></span>
...
<div id="panelContainer" style="width: 489px" class="clearfix">
    ...
    <br class="clearBR" />
    <img id="lCredit" src="panels/credits_left.png" alt="" class="creditsImage twoPanelImage threePanelImage" /><img id="TwoPanelCreditsSpacer" class="creditsSpacer twoPanelImage" src="panels/2panel_credits_spacer.gif" alt="" /><img id="ThreePanelCreditsSpacer" class="creditsSpacer threePanelImage hidden notShowing" src="panels/3panel_credits_spacer.gif" alt="" /><img id="mCredit" src="panels/credits_middle.png" alt="" class="creditsImage hidden notShowing" /><img id="rCredit" src="panels/credits_right.png" alt="" class="creditsImage twoPanelImage threePanelImage" />
...
<div class="bottomLocks clearfix">
